...
namespace RTCIL::CIL
{
    struct OpCode
    {
        RTCLI_FORCEINLINE Code Code(void) RTCLI_NOEXCEPT;
        RTCLI_FORCEINLINE StackBehaviour StackBehaviourPop(void) RTCLI_NOEXCEPT;
        RTCLI_FORCEINLINE StackBehaviour StackBehaviourPush(void) RTCLI_NOEXCEPT;
        RTCLI_FORCEINLINE RTCLI::string Name(void) RTCLI_NOEXCEPT;
    };
